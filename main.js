...
/* harmony import */ var _main_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
...
// Module
exports.push([module.i, ".body_defaultback{margin:0}.color-block{margin:0;display:flex;justify-content:left;padding:10px}.color-block__color-box{width:70px;height:70px;border-radius:6px}.color-block__color-box_darkshade100{background-color:#1f2041}.color-block__color-box_darkshade75{background-color:rgba(31,32,65,0.75)}.color-block__color-box_darkshade50{background-color:rgba(31,32,65,0.5)}.color-block__color-box_darkshade25{background-color:rgba(31,32,65,0.25)}.color-block__color-box_darkshade5{background-color:rgba(31,32,65,0.05)}.color-block__color-box_purple{background-color:#BC9CFF}.color-block__color-box_green{background-color:#6FCF97}.color-block__text-box{padding:5px 5px 5px 40px}.color-block__text{font-family:Quicksand;font-size:19px;line-height:29px;margin:0}.color-block__text_bold{font-weight:bold}.positioner{margin:135px auto;max-width:1125px}.text-block{padding:10px;margin:0}.text-block_h43{height:43px}.text-block_h78{height:78px}.text-block_h90{height:90px}.text-block_grid-col1{grid-column:1}.text-block_grid-col2{grid-column:2}.col2-container{display:flex;justify-content:space-between;flex-wrap:wrap}.text_bodytext{font-family:Montserrat;font-style:normal;font-weight:normal;font-size:14px;line-height:24px;color:rgba(31,32,65,0.75)}.text_label{font-family:Montserrat;font-style:normal;font-weight:bold;font-size:12px;line-height:15px;color:#1f2041;text-transform:uppercase;letter-spacing:0.1px}.text_item-title{font-family:Quicksand;font-style:normal;font-weight:bold;font-size:19px;line-height:24px;letter-spacing:0.15px;color:#1f2041}.text_sub-section{font-family:Quicksand;font-style:normal;font-weight:bold;font-size:24px;line-height:30px;letter-spacing:-0.1px;color:#1f2041}.text_align-right{text-align:right}.text_light-25p{color:rgba(31,32,65,0.25);font-weight:normal}.container_w340{width:340px}.container_w370{width:370px}.container_w380{width:380px}.container_w420{width:420px}.container_w430{width:430px}.container_grid-top{display:grid;grid-column-gap:10px;grid-template:repeat(4, min-content) auto/auto 1fr}\n", ""]);
// Exports
